...
import serviceImplementationMethods.JavaFileMethodsServiceImplementation;
...
//    @Autowired
    private JavaFileMethodsServiceImplementation javaFileMethodsServiceImplementation;

    /* 1.addNewMethod */
    @RequestMapping(value = "addNewMethod", method = RequestMethod.POST)
    public Response addNewMethod(@RequestBody JavaFileMethods javaFileMethods) {
        return javaFileMethodsServiceImplementation.fileAddNewMethod(javaFileMethods);
    }

    /* 2.fileUpdateMethod */
    @RequestMapping(value = "fileUpdateMethod", method = RequestMethod.POST)
    public Response fileUpdateMethod(@RequestBody JavaFileMethods javaFileMethods) {
        return javaFileMethodsServiceImplementation.fileUpdateMethod(javaFileMethods);
    }

    /* 3.fileViewById */
    @RequestMapping(value = "fileViewById/{fileId}", method = RequestMethod.GET)
    public Response fileViewById(@PathVariable Integer fileId) {
        return javaFileMethodsServiceImplementation.fileViewById(fileId);
    }

    /* 4.fileViewByMethodName */
    @RequestMapping(value = "fileViewByMethodName", method = RequestMethod.GET)
    public Response fileViewByMethodName(@PathVariable String fileMethodName) {
        return javaFileMethodsServiceImplementation.fileViewByMethodName(fileMethodName);
    }

    /* 5.fileMethodsList */
    @RequestMapping(value = "fileMethodsList", method = RequestMethod.GET)
    public Response fileMethodsList() {
        return javaFileMethodsServiceImplementation.fileMethodsList();
    }

    @RequestMapping(value = "fileHandlingMethods", method = RequestMethod.GET)
    public Map<String, Object> fileHandlingMethods() throws IOException, FileNotFoundException {
